...
6. **岗位投递模块**：完整实现了岗位收藏和投递状态跟踪，符合课程完整要求。
...
- 链接：https://pan.quark.cn/s/2268634e7df1?pwd=MzG2
- 提取码：MzG2

> 视频时长约 5 分钟，展示了项目目录、技术栈、服务启动、Swagger 接口测试（注册、登录、任务、岗位、收藏、投递、统计）以及项目亮点说明。
...
1. **Swagger 接口测试**：学会用 Swagger 验证每个接口的正常和异常情况，并整理测试截图。
2. **接口测试清单整理**：把每个接口的 Method、URL、Token 需求、正常测试、异常测试整理成 `api_test_checklist.md`。
3. **README 写作**：理解 README 是项目的"说明书"，从第一人称视角写清楚项目介绍、技术栈、运行方式、遇到的问题和解决方法。
4. **演示视频录制**：学习如何在 3 到 5 分钟内讲清楚项目价值，包括项目目录展示、接口演示和亮点说明。
5. **Git 分批提交**：按照 `chore`、`feat`、`docs` 等规范，将项目代码和文档分批提交到远程仓库。
